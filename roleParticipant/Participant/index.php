      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
            ...
            <div class="menu_section">
              <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-pencil-square-o"></i> Notulensi <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="index.php?page=addnotulen_cfs">Tambah Notulensi Baru</a></li>
                    <li><a href="#">Unduh Template</a></li>
                  </ul>
                </li>
              </ul>
            </div>
          ...
          <div class="sidebar-footer hidden-small">
            <a data-toggle="tooltip" data-placement="top" title="Pengaturan" href="#">
              <span class="glyphicon glyphicon-cog" aria-hidden="true"></span>
            </a>
            <a data-toggle="tooltip" data-placement="top" title="Layar Penuh" href="#">
              <span class="glyphicon glyphicon-fullscreen" aria-hidden="true"></span>
            </a>
            <a data-toggle="tooltip" data-placement="top" title="Kunci" href="#">
              <span class="glyphicon glyphicon-eye-close" aria-hidden="true"></span>
            </a>
            <a data-toggle="tooltip" data-placement="top" title="Keluar" href="#">
