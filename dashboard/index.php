        ...
        <div class="left_col scroll-view">
          <div class="navbar nav_title" style="border: 0;">
            <div style="margin-left: 12px;">
              &nbsp; <a href="index.php" class="fa fa-users fa-2x" style="color:#fff;">
                <span style="font-family: Arial, Helvetica, sans-serif; font-size: 26px" color="white">ConferBooth</span></a>
            </div>
          </div>
          ...
          <div class="profile clearfix">
            ...
            <div class="profile_info">
              ...
              <h2 style="font-size: 20px;">User</h2>
            </div>
          </div>
          <!-- /menu profile quick info -->
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
              <ul class="nav side-menu">
                ...
                <li><a href="#"><i class="fa fa-calendar"></i> Vocation <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="#">List Vocation</a></li>
                    <li><a href="index.php?page=tampil_cfs">Detail Conference</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-user"></i> Personal <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="#">List Personal</a></li>
                    <li><a href="#">Personal Details</a></li>
                  </ul>
                </li>
                <li><a><i class="fa fa-file"></i> Conference <span class="fa fa-chevron-down"></span></a>
                  <ul class="nav child_menu">
                    <li><a href="index.php?page=tambah_cfs">Create New Conference</a></li>
                  </ul>
                </li>
